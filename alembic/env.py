...
# Inject the DB URL from our settings (not from alembic.ini)
# This means alembic uses the same DATABASE_URL env var as the app
...
async def run_async_migrations() -> None:
    ...
    connectable = async_engine_from_config(
        ...
        prefix="sqlalchemy.",
        poolclass=pool.NullPool,  # NullPool: don't pool during migrations
    )
